        ...
        <footer class="footer center">
            ...
            <div class="footer__center">
                ...
                <div class="footer__pages">
                    <a href="index.html"><span class="menu__text">Home</span></a>
                    <a href="#"><span class="menu__text">Project</span></a>
                    <a href="blog.html"><span class="menu__text">Blog</span></a>
                </div>
            </div>
            <div class="footer__right">
                <div class="footer__title">Contact</div>
                <p class="menu__text">55 East Birchwood Ave. Brooklyn, New York 11201</p>
                <p class="menu__text">contact@interno.com</p>
                <p class="menu__text">(123) 456 - 7890</p>
            </div>
        </footer>
    </div>
</template>
